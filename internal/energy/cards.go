...
var Cards = []Card{
	...
	},
	{
		...
		SpecialRule: "Neue Kohle-Brennkammern und Transformatoren starten mit 1 Ladung weniger",
		Shifts: [5]board.ShiftDemands{
			{Industry: 1, Residential: 1, Rail: 0, Plant: 0},
	...
	},
	{
		...
		SpecialRule: "Absorber-Staebe und Kuehltuerme verlieren ihre Funktion",
		Shifts: [5]board.ShiftDemands{
			{Industry: 2, Residential: 2, Rail: 1, Plant: 1},
	...
	},
	{
		...
		SpecialRule: "Spieler 1 muss 2 Waerme-Chips am Zuender feuern",
		Shifts: [5]board.ShiftDemands{
			{Industry: 1, Residential: 1, Rail: 1, Plant: 1},
			{Industry: 2, Residential: 2, Rail: 1, Plant: 1},
			{Industry: 4, Residential: 2, Rail: 2, Plant: 2},
			{Industry: 6, Residential: 1, Rail: 2, Plant: 2},
			{Industry: 7, Residential: 2, Rail: 1, Plant: 2},
		},
	},
}
